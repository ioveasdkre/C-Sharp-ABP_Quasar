...
using Barc.APS.Models.TokenAuth;
...
{
    public abstract class APSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static APSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(APSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<APSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<APSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<APSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<APSDbContext, Task<T>> func)
        {
            T result;
